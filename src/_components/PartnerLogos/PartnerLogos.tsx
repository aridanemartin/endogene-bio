...
export const PartnerLogos = () => {
  return (
    <section className="partnerLogos">
      <Image src={genopoleLogo} alt="Partner Logos" width={100} height={100} />
      <Image
        src={eitLogo}
        alt="Partner Logos"
        width={100}
      ...
      />
      <Image src={frontlineLogo} alt="Partner Logos" width={100} height={40} />
      <Image src={stationFLogo} alt="Partner Logos" width={100} height={100} />
    </section>
  )
}
