    ...
    <div className="legal">
      ...
      <Layout maxWidth="1450px">
        <div className="legalText">
          <h2 className="legalTextTitle">AVISO LEGAL</h2>
          <h2>INTRODUCCIÓN</h2>
          <p>
            El presente documento tiene como finalidad el establecer y regular
            las normas de uso de este portal web, entendiendo por éste todas las
            páginas y sus contenidos, propiedad de CAROLINA ALMEIDA RAMÍREZ , a
            las cuales se accede a través del dominio
            https://www.nutricionsaludablelaspalmas.com. La utilización del
            portal web atribuye la condición de usuario del mismo e implica la
            aceptación de todas las condiciones incluidas en el presente aviso
            Legal. El usuario se compromete a leer atentamente el presente aviso
            Legal en cada una de las ocasiones en que se proponga utilizar
            nuestro portal web, ya que éste y sus condiciones de uso recogidas
            en el presente aviso Legal pueden sufrir modificaciones
          </p>
